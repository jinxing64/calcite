...
public class MaterializationTest {
  ...
  private void checkMaterialize(String materialize, String query) {
    checkThatMaterialize(materialize, query, "m0", false, HR_FKUK_MODEL, CONTAINS_M0,
        RuleSets.ofList(ImmutableList.of())).sameResultWithMaterializationsDisabled();
  }
  ...
  @Test public void testCalcToCalc0() {
    checkMaterialize(
        "select * from \"emps\" where \"deptno\" = 10",
        "select \"empid\" + 1 from \"emps\" where \"deptno\" = 10");
  }

  @Test public void testCalcToCalc1() {
    checkMaterialize(
        "select \"deptno\", \"empid\" from \"emps\"",
        "select \"empid\" + 1 as x from \"emps\" where \"deptno\" = 10");
  }

  @Test public void testCalcToCalc2() {
    checkMaterialize(
        "select \"deptno\", \"empid\" from \"emps\"",
        "select \"empid\" + 1 as x from \"emps\" where \"deptno\" = 10");
  }

  @Test public void testCalcToCalc3() {
    checkMaterialize(
        "select \"deptno\", \"empid\", \"name\" from \"emps\"",
        "select \"empid\" + 1 as x from \"emps\" where \"deptno\" = 10");
  }

  @Test public void testCalcToCalc4() {
    checkMaterialize(
        "select \"deptno\", \"empid\", \"name\" from \"emps\"",
        "select \"empid\" + 1 as x, \"name\" from \"emps\" where \"deptno\" = 10");
  }

  @Test public void testCalcToCalc5() {
    checkMaterialize(
        "select \"deptno\" - 10 as \"x\", \"empid\" + 1, \"name\" from \"emps\"",
        "select \"name\" from \"emps\" where \"deptno\" - 10 = 0");
  }

  @Test public void testCalcToCalc6() {
    checkMaterialize(
        "select \"salary\", \"commission\", \"deptno\", \"empid\", \"name\" from \"emps\"",
        "select * from\n"
            + "(select * from \"emps\" where \"name\" is null) where \"commission\" is null");
  }

  @Test public void testCalcToCalc7() {
    checkMaterialize(
        "select \"deptno\", \"empid\", \"name\" from \"emps\" where \"deptno\" = 10",
        "select \"empid\" + 1 as x, \"name\" from \"emps\" where \"deptno\" = 10");
  }

  @Test public void testCalcToCalc8() {
    checkMaterialize(
        "select \"deptno\", \"empid\", \"name\" from \"emps\" where \"deptno\" = 10",
  ...
  @Test public void testCalcToCalc9() {
    checkMaterialize(
        "select * from \"emps\" where \"deptno\" > 10",
        "select \"name\" from \"emps\" where \"deptno\" > 30");
  }

  @Test public void testCalcToCalc10() {
    checkMaterialize(
        "select \"name\", \"deptno\" from \"emps\" where \"deptno\" > 10",
        "select \"name\" from \"emps\" where \"deptno\" > 30");
  }

  @Test public void testCalcToCalc11() {
    checkMaterialize(
  ...
  @Test public void testCalcToCalc12() {
    checkMaterialize(
  ...
  @Test public void testCalcToCalc13() {
